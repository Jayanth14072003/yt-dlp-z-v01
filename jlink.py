...
async def get_accesstoken():
    ...
    id = await requests.get(url=IdURL).json()['id']

    token = await requests.post(url=GuestURL, json={
            'adId': id,
...
async def mpd_call(dlink):
    import requests
    access_token = get_accesstoken()
    print(access_token)
    print(type(access_token))
    access_token = " eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9..LRt-289NXSiObcKMCYg_3tYLtE0HMGnIoMQMT9lZ6aGBWwXDmU6DBrb2UGZ98XgmYREO0VJ1K_0wx7Rt8f_Q7w"
    ...
    async def replace_invalid_chars(title: str) -> str:
        invalid_chars = {'<': '\u02c2', '>': '\u02c3',
        ':': '\u02d0', '"': '\u02ba', '/': '\u2044',
        '\\': '\u29f9', '|': '\u01c0', '?': '\u0294',
        '*': '\u2217'}
